...
(function(h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "لا يوجد بيانات مسجلة الجدول فارغ",
            sInfo: "إظهار _START_ إلى _END_ من _TOTAL_ المدخلات",
            sInfoEmpty: "إظهار 0 إلى 0  من 0 المدخلات",
            sInfoFiltered: "( _MAX_ أجمالى المدخلات)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "إظهار _MENU_ مدخلات",
            sLoadingRecords: "تحميل ...",
            sProcessing: "جارى المعالجة ...",
            sSearch: "بحث:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "لا يوجد بيانات متطابقة للبحث"
        },
