...
<div class="content">
    <div class="col-sm-12">
        <section class="page-heading">
            <div class="col-sm-6">
                <h2>إيرادات مقدمى الخدمة</h2>
            </div><!--End col-md-6-->
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    <li><a href="{{ route('home') }}">الرئيسية</a></li>
                    <li>مقدمى الخدمة</li>
                    <li class="active">إيرادات مقدمى الخدمة</li>
                </ul>
            </div><!--End col-md-6-->
            ...
            <div class="widget-content requests">
                ...
                <div class="col-sm-12">
                    <div class="ui form">
                        ...
                        <div class="ui field">
                            <label>مقدمى الخدمة<span class="require">*</span></label>
                            <div class="ui input">
...
$("body").on("click",".incomeSrchBut", function(){
    ...
    var to     = $(".to_date").val();
    var id     = $(".select").val();
    var posted = {'from':from, 'to':to, 'id':id, 'type':'provider'};
    $.ajax({
