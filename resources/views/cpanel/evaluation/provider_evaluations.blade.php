                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="result">
                            ...
                            <tr>
                                ...
                                <td class="width-90">
                                    <a class="img-popup-link" href="{{ $evaluation->provider_pic }}">
                                        <img src="{{ $evaluation->provider_pic }}" class="table-img">
                                    </a>
                                </td>
                                <td>{{ $evaluation->provider_name }}</td>
                                <td>{{ $evaluation->provider_phone }}</td>
