...
<div class="content">
    <div class="col-sm-12">
        <section class="page-heading">
            <div class="col-sm-6">
                <h2>إيرادات المسوقين</h2>
            </div><!--End col-md-6-->
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    <li><a href="{{ route('home') }}">الرئيسية</a></li>
                    <li>المسوقين</li>
                    <li class="active">إيرادات المسوقين</li>
                </ul>
            </div><!--End col-md-6-->
            ...
            <div class="widget-content requests">
                ...
                <div class="col-sm-12">
                    <div class="ui form">
                        ...
                        <div class="ui field">
                            <label>المسوقين<span class="require">*</span></label>
                            <div class="ui input">
                                <select class="js-example-basic-single select form-control">
                                    @if($marketers->count())
                                        @foreach($marketers AS $marketer)
                                            <option value="{{ $marketer->marketer_code }}">{{ $marketer->full_name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>قيمة المسوق</th>
                                                <th>القيمه من مقدم الخدمه</th>
                                                <th>القيمة من لاموصل</th>
                                                <th>الحالة</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tableBody">
...
$("body").on("click",".incomeSrchBut", function(){
    ...
    var to     = $(".to_date").val();
    var code     = $(".select").val();
    var posted = {'from':from, 'to':to, 'code':code, 'type':'marketer'};
    $.ajax({
        url: "{{ route('marketer.income.search') }}",
        type:"POST",
        data:posted,
        dataType:"JSON",
