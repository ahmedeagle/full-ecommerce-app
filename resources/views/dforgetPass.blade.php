		...
		<div class="col-sm-6 col-sm-offset-3 vcenter">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form method="POST" class="form-horizontal" action="{{ route('dForgetPassAction') }}">
						...
						<div class="form-group">
						    <label for="password" class="control-label col-sm-4">كلمة السر الجديدة : </label>
						...
						<div class="form-group">
						    <label class="control-label col-sm-4" for="password_confirmation">تأكيد كلمة السر : </label>
						    <div class="col-sm-7 input-group">
						    	<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
