		...
		<div class="col-sm-6 col-sm-offset-3 vcenter">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form method="POST" class="form-horizontal" action="{{ route('pForgetPassAction') }}">
						...
						@if(session()->has('err'))
						<div class="alert alert-danger">
						 	<strong>خطأ!</strong> {{ session('err') }}
						</div>
						@endif
						<div class="form-group">
						    <label for="password" class="control-label col-sm-4">الرقم السرى الجديد :</label>
						...
						<div class="form-group">
						    <label class="control-label col-sm-4" for="password_confirmation">تأكيد الرقم السرى : </label>
						    <div class="col-sm-7 input-group">
						    	<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
